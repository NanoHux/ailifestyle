...
// @ts-nocheck 
/*
 * This file exports the `DayReflection` model and its related types.
 *
...
export type GetDayReflectionAggregateType<T extends DayReflectionAggregateArgs> = {
      [P in keyof T & keyof AggregateDayReflection]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDayReflection[P]>
    : Prisma.GetScalarType<T[P], AggregateDayReflection[P]>
}
...
type GetDayReflectionGroupByPayload<T extends DayReflectionGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DayReflectionGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof DayReflectionGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], DayReflectionGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], DayReflectionGroupByOutputType[P]>
      }
    >
  >
...
export type DayReflectionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<DayReflectionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface DayReflectionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['DayReflection'], meta: { name: 'DayReflection' } }
  /**
   ...
   * })
  **/
  count<T extends DayReflectionCountArgs>(
    args?: Prisma.Subset<T, DayReflectionCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DayReflectionCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends DayReflectionGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, DayReflectionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDayReflectionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
